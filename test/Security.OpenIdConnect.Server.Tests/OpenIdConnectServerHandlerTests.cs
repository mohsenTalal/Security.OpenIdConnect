...
using Security.OpenIdConnect.Client;
using Security.OpenIdConnect.Extensions;
...
namespace Security.OpenIdConnect.Server.Tests
{
                ...
                services.AddAuthentication()
                    ...
                    .AddOpenIdConnectServer(options =>
                    {
                        ...
                        options.SigningCredentials.AddCertificate(
                            ...
                            resource: "Security.OpenIdConnect.Server.Tests.Certificate.pfx",
